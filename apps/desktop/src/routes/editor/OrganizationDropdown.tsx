...
export function OrganizationDropdown() {
	...
	const fallbackDescription = createMemo(() => {
		...
		if (availability === "loading") {
			return "Fetching organization branding.";
		}
		if (availability === "unavailable") {
			return "Organization branding uses live FrameCast data. Connect to FrameCast to select an organization and use its colours.";
		}
